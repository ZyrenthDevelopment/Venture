      ...
      <div id="app" className='_app App__Authentication'>
        <div className='Authentication__TextLogin'>
          ...
          <div className="TextLogin__TL_Inputs">
            ...
            <input type="password" name="Password" id="password" placeholder='Password' className='TL_Inputs__Input' />
            <p className="TL_Inputs__Error hidden"></p>
            <button className='TL_Inputs__Button' onClick={() => {
          ...
          <div className="TextLogin__TL_Footer">
            ...
            <Link href='#'><a className="TL_Footer__Link" onClick={e => e.target['innerHTML'] = 'skill issue (not finished yet)'}>Register</a></Link>
          </div>
          <div id="captcha"></div>
        </div>
